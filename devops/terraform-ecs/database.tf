...
resource "aws_vpc_endpoint" "secretsmanager" {
  ...
  security_group_ids  = [aws_security_group.tasks_sg.id]
}
...
resource "aws_serverlessapplicationrepository_cloudformation_stack" "rotate-stack" {
  ...
  parameters = {
    ...
    vpcSecurityGroupIds = aws_security_group.tasks_sg.id
  }
}
...
resource "aws_db_instance" "default" {
  ...
  vpc_security_group_ids = [aws_security_group.tasks_sg.id]
