...
public class AppConfig {
    ...
    public void printSecretKey() {
        // Printing the secret key using instance field `security`
        System.out.println("Secret Key: " + this.security.getSecretKey());
        // Or use a logger with appropriate log level
    }
